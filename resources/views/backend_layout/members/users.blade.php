                    ...
                    <table id="example" class="table table-actions table-striped table-hover mb-0" data-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @if($all->status == 1)
                            <a class="btn btn-sm btn-danger" href="{{url('/unactive-user/' . $all->pk_id)}}">
                                <i class="fas fa-thumbs-down"></i>
                            </a>
                            @else
                                <a class="btn btn-sm btn-success" href="{{url('/active-user/' . $all->pk_id)}}">
                           ...
                           <td> 
                            <a href="{{url('/delete-user/' . $all->pk_id)}}" class="btn btn-sm btn-danger" data-toggle="confirmation" data-title="Delete user?">Delete</a>
                          </td>
