...
<html lang="en">
  <head>
    <title>Jehazak | Vendor Dashboard</title>
    <meta charset="utf-8">
        ...
        -->
          ...
          <li class="nav-item dropdown">
            <a class="nav-link avatar-with-name" id="navbarDropdownMenuLink" data-toggle="dropdown" href="#">
              <img src="{{URL::to('/')}}/storage/{{auth()->guard('vendor')->user()->avatar}}" class="d-inline-block align-top" alt="">
            </a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item text-danger" href="{{url('/vendor/logout')}}">Sign out</a>
            </div>
          </li>
        </ul>
      </nav>
      ...
      <div class="adminx-sidebar expand-hover push">
        ...
        <ul class="sidebar-nav">
          <li class="sidebar-nav-item">
            <a href="{{url('/vendor/dashboard')}}" class="sidebar-nav-link active">
          ...
          <li class="sidebar-nav-item">
            ...
            <ul class="sidebar-sub-nav collapse" id="category">
              <li class="sidebar-nav-item">
                <a href="{{url('/vendor/category')}}" class="sidebar-nav-link">
               ...
               <li class="sidebar-nav-item">
                <a href="{{url('/vendor/add-category')}}" class="sidebar-nav-link">
                  <span class="sidebar-nav-abbr">
          ...
          <li class="sidebar-nav-item">
            ...
            <ul class="sidebar-sub-nav collapse" id="subcategory">
              <li class="sidebar-nav-item">
                <a href="{{url('/vendor/subcategory')}}" class="sidebar-nav-link">
                  <span class="sidebar-nav-abbr">
                    <i class="fas fa-table"></i>
                  </span>
                  <span class="sidebar-nav-name">
               ...
               <li class="sidebar-nav-item">
                <a href="{{url('/vendor/add-subcategory')}}" class="sidebar-nav-link">
                  <span class="sidebar-nav-abbr">
                   <i class="fas fa-plus"></i> 
                  </span>
                  <span class="sidebar-nav-name">
          ...
          <li class="sidebar-nav-item">
            ...
            <ul class="sidebar-sub-nav collapse" id="manufacture">
              <li class="sidebar-nav-item">
                <a href="{{url('/vendor/manufacture')}}" class="sidebar-nav-link">
                  <span class="sidebar-nav-abbr">
                    <i class="fas fa-table"></i>
                  </span>
                  <span class="sidebar-nav-name">
               ...
               <li class="sidebar-nav-item">
                <a href="{{url('/vendor/add-manufacture')}}" class="sidebar-nav-link">
                  <span class="sidebar-nav-abbr">
                   <i class="fas fa-plus"></i> 
                  </span>
                  <span class="sidebar-nav-name">
          ...
          <li class="sidebar-nav-item">
                <a href="{{url('/vendor/add-product')}}" class="sidebar-nav-link">
                  <span class="sidebar-nav-abbr">
                   <i class="fas fa-plus"></i> 
                  </span>
                  <span class="sidebar-nav-name">
